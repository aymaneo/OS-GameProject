...
OBJECTSNAMES=\
 PlatformManager Clavier cpu_context_switch cpu_context\
 Ecran Platform\
 fonctionsES\
 gdt \
 ...
 BrickManager Brick CollisionManager Compteur  Pagination MemoireTab\
...
run_gui: $(KERNEL_OBJ)
	$(QEMU) -net nic,model=ne2k_isa -m 40M -net user,tftp=./build/boot -cdrom ./build/boot/grub.iso
